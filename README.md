...
There are specific steps to consider when begining the react development process. There are serious questions to answer about what individual components need to be created in order to deliver the final product. Deciding which component of the group will be the 'parent' and responsible for passing data to the child components. "To build your app correctly, you first need to think of the minimal set of mutable state that your app needs." Equally as important in the process is deciding which component is the right choice for maintaining state within the app. 
